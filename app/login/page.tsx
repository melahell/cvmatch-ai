...
// Google Logo SVG (official brand colors - EXEMPTION: Required by Google brand guidelines)
...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex w-full">
                    ...
                    >
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/20">
                            <div className="flex items-center gap-4 mb-3">
                                <div className="w-10 h-10 rounded-full bg-semantic-success flex items-center justify-center font-bold text-white">M</div>
                                <div>
                                    <div className="text-white font-medium">Marc Dupont</div>
                                    <div className="text-xs text-neon-pink/80">Product Manager</div>
                                </div>
                            </div>
            ...
            {/* RIGHT COLUMN: Form */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface-primary">
                <div className="w-full max-w-md space-y-6">
                    <div className="text-center">
                        <div className="flex justify-center mb-4">
                            <Logo size="lg" showText={false} asStatic />
                        </div>
                        <h2 className="text-3xl font-bold text-cvText-primary">Bienvenue</h2>
                        <p className="text-cvText-secondary mt-2">Connectez-vous pour accéder à votre dashboard</p>
                    </div>

                    <Button
                        onClick={handleGoogleLogin}
                        className="w-full h-12 text-lg bg-surface-primary border border-cvBorder-light text-cvText-primary hover:bg-surface-secondary transition-all hover:scale-[1.02] flex items-center justify-center gap-3"
                    >
                        <GoogleLogo />
                    ...
                    <div className="relative">
                        <div className="absolute inset-0 flex items-center">
                            <span className="w-full border-t border-cvBorder-light" />
                        </div>
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-surface-primary px-2 text-cvText-secondary">Ou par email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="h-10 bg-surface-secondary border-cvBorder-light focus:ring-2 focus:ring-neon-purple"
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <p className="text-center text-xs text-cvText-secondary">
