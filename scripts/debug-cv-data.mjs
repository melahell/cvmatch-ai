// scripts/debug-cv-data.mjs
// Run with: node scripts/debug-cv-data.mjs
...
async function debugCVData() {
    ...
    for (let i = 0; i < experiences.length; i++) {
        ...
        console.log(`${i + 1}. ${exp.poste?.substring(0, 40)} | _format: ${exp._format} | _score: ${exp._relevance_score}`);
    }
}
