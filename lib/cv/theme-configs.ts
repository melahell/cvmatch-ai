...
export const CV_THEMES: Record<CVThemeId, CVThemeConfig> = {
    classic: {
        ...
        zones: {
            ...
            projects: { name: "projects", capacity_units: 15, min_units: 0, flex: true, flex_priority: 4, overflow_strategy: "compact" },
            ...
            clients: { name: "clients", capacity_units: 10, min_units: 0, flex: true, flex_priority: 5, overflow_strategy: "compact" },
        },
        adaptive_rules: {
    ...
    modern: {
        ...
        zones: {
            ...
            clients: { name: "clients", capacity_units: 12, min_units: 0, flex: true, flex_priority: 5, overflow_strategy: "compact" },
        },
        adaptive_rules: {
    ...
    tech: {
        ...
        zones: {
            ...
            clients: { name: "clients", capacity_units: 12, min_units: 0, flex: true, flex_priority: 6, overflow_strategy: "compact" },
        },
        adaptive_rules: {
            min_detailed_experiences: 1,
            prefer_detailed_for_recent: true,
