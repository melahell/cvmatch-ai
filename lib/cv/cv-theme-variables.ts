...
const TEMPLATE_OVERRIDES: Record<string, Partial<CVThemeVariables>> = {
    ...
    elegant: {
        "--cv-primary": "#1e293b",
        "--cv-primary-light": "#1e293b10",
        "--cv-sidebar-bg": "#ffffff",
        "--cv-sidebar-text": "#1f2937",
        "--cv-sidebar-accent": "#64748b",
        "--cv-font-body": "'Libre Baskerville', Georgia, 'Times New Roman', serif",
        "--cv-font-heading": "'Libre Baskerville', Georgia, 'Times New Roman', serif",
        "--cv-sidebar-width": "0",
    },
    executive: {
        "--cv-primary": "#1e40af",
        "--cv-primary-light": "#1e40af12",
        "--cv-sidebar-bg": "#1e293b",
        "--cv-sidebar-text": "#f1f5f9",
        "--cv-sidebar-accent": "#60a5fa",
        "--cv-sidebar-width": "70mm",
    },
    terminal: {
        "--cv-primary": "#10b981",
        "--cv-primary-light": "#10b98112",
        "--cv-sidebar-bg": "#0f172a",
        "--cv-sidebar-text": "#e2e8f0",
        "--cv-sidebar-accent": "#34d399",
        "--cv-font-body": "var(--font-mono), 'JetBrains Mono', ui-monospace, SFMono-Regular, monospace",
        "--cv-font-heading": "var(--font-mono), 'JetBrains Mono', ui-monospace, SFMono-Regular, monospace",
        "--cv-sidebar-width": "68mm",
    },
    metropolis: {
        "--cv-primary": "#7c3aed",
        "--cv-primary-light": "#7c3aed12",
        "--cv-sidebar-bg": "#4c1d95",
        "--cv-sidebar-text": "#f5f3ff",
        "--cv-sidebar-accent": "#a78bfa",
        "--cv-sidebar-width": "0",
    },
    horizon: {
        "--cv-primary": "#0f766e",
        "--cv-primary-light": "#0f766e10",
        "--cv-sidebar-bg": "#ffffff",
        "--cv-sidebar-text": "#1f2937",
        "--cv-sidebar-accent": "#14b8a6",
        "--cv-sidebar-width": "0",
    },
    catalyst: {
        "--cv-primary": "#e11d48",
        "--cv-primary-light": "#e11d4812",
        "--cv-sidebar-bg": "#881337",
        "--cv-sidebar-text": "#fce7f3",
        "--cv-sidebar-accent": "#fb7185",
        "--cv-sidebar-width": "0",
    },
};
