            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-700">
                        ...
                        <button
                            onClick={onClose}
                            className="text-slate-600 hover:text-slate-600 dark:hover:text-slate-300 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
                        >
                            <X className="w-5 h-5" />
                        </button>
                    </div>
                            ...
                            {TEMPLATES.filter(t => !t.available).map((template) => (
                                ...
                                >
                                    <div className="aspect-[210/297] bg-slate-100 dark:bg-slate-800 rounded-lg mb-3 flex items-center justify-center">
                                        <span className="text-sm text-slate-600">Bientôt</span>
                                    </div>
            ...
            {template.recommended && (
                <div className="flex flex-wrap gap-1 mt-2">
                    {template.recommended.slice(0, 2).map((rec, i) => (
                        <span
                            key={i}
                            className="text-[10px] px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-slate-600"
                        >
                            {rec}
                        </span>
                    ))}
