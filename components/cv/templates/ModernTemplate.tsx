    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Références Clients - Grid 2 colonnes propre */}
                {clients_references && clients_references.clients && clients_references.clients.length > 0 && (
                    <div className="space-y-2 mb-4">
                        ...
                        {clients_references.secteurs && clients_references.secteurs.length > 0 ? (
                            <div className="space-y-2">
                                {clients_references.secteurs.slice(0, 4).map((group, i) => (
                                    <div key={i}>
                                        <span className="inline-block bg-indigo-600 text-white text-[6pt] uppercase font-bold px-1.5 py-0.5 rounded mb-1">
                                            {group.secteur}
                                        </span>
                                        <div className="grid grid-cols-2 gap-x-2 gap-y-0.5 text-[8pt] text-slate-200">
                            ...
                            <div className="grid grid-cols-2 gap-x-2 gap-y-0.5 text-[8pt] text-slate-200">
                                {clients_references.clients.slice(0, 8).map((client: string, i: number) => (
