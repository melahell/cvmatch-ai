...
describe("truncateForRAGIncrementalExtraction", () => {
    it("doit tronquer sous ~8k tokens et insérer le marqueur si nécessaire", () => {
        const tokenTarget = 12000;
        ...
        expect(estimateTokenCount(res.text)).toBeLessThanOrEqual(8000);
    });
});
