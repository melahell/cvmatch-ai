    ...
    theme: {
    	extend: {
    		colors: {
    			...
    			slate: {
    				'50': 'hsl(var(--cv-surface-secondary))',
    				'100': 'hsl(var(--cv-surface-tertiary))',
    				'200': 'hsl(var(--cv-border-light))',
    				'300': 'hsl(var(--cv-border-medium))',
    				'400': 'hsl(var(--cv-text-tertiary))',
    				'500': 'hsl(var(--cv-text-secondary))',
    				'600': 'hsl(var(--cv-text-secondary))',
    				'700': 'hsl(var(--cv-text-primary))',
    				'800': 'hsl(var(--cv-text-primary))',
    				'900': 'hsl(var(--cv-text-primary))',
    				'950': 'hsl(var(--cv-text-primary))',
    			},
    			blue: {
    				'50': 'hsl(var(--cv-neon-indigo, 239 84% 67%) / 0.08)',
    				'100': 'hsl(var(--cv-neon-indigo, 239 84% 67%) / 0.12)',
    				'200': 'hsl(var(--cv-neon-indigo, 239 84% 67%) / 0.18)',
    				'500': 'hsl(var(--cv-neon-indigo, 239 84% 67%))',
    				'600': 'hsl(var(--cv-neon-purple, 270 71% 66%))',
    				'700': 'hsl(var(--cv-neon-purple, 270 71% 66%))',
    			},
    			semantic: {
